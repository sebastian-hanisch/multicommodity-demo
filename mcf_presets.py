...
SETTING_SPECS = {
    ...
    "order_radio": SettingSpec("order", _choice(C.ORDER_LABELS), C.DEFAULT_ORDER),
...
PRESET_KEYS = {"net": "net_select", "k": "k_slider", "order": "order_radio", "p": "p_slider", "d": "d_slider", "s": "s_slider", "density": "density_slider",
...
STEPS = {"density_slider": 10, "spread_slider": 25, "load_slider": 10}
